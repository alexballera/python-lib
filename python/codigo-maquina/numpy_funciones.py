...
#%%
print(f"Suma {np.add(arreglo1, arreglo2)}")
print(f"Resta {np.subtract(arreglo1, arreglo2)}")
print(f"Divide {np.divide(arreglo1, arreglo2)}")
print(f"Multiplicación {np.multiply(arreglo1, arreglo2)}")
print(f"Potencia {np.power(arreglo1, 2)}")
print(f"Abs {np.absolute(arreglo1)}")
#%%
...
imc = np.frompyfunc(imc, 2, 1) # type: ignore # 2 parámetros 1 elemento de salida
