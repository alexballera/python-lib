...
#%% Búsquedas con where
print(f'where arreglo == 13 {np.where(arreglo == 13)}') # devuelve un array con las posiciones
print(f'where arreglo >= 13 {np.where(arreglo >= 13)}')
#%% Filtros
filtro = [True, False, False, True, True]
print(f'arreglo filtro {arreglo[filtro]}')
#%%
...
#%% Filtros
print(peso[peso > 90])
print(f'\npais[peso > 90]: \n{pais[peso > 90]}, {pais[peso > 90].size}')
print(f'\npais[altura > 1.80]: \n{pais[altura > 1.80]}, {pais[altura > 1.80].size}')
print(f'\npais[(altura > 1.80) & (peso > 90)]: \n{pais[(altura > 1.80) & (peso > 90)]}, {pais[(altura > 1.80) & (peso > 90)].size}')
print(f'\npais[(altura > 1.80) | (peso > 90)]: \n{pais[(altura > 1.80) | (peso > 90)]}, {pais[(altura > 1.80) | (peso > 90)].size}')
# %%
